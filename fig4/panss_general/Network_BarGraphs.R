...
setwd("~/Dropbox/DP5_N-Bridge/Figure_Calculations/GSR/Behaviour/PANSS_G")

# read in mask
mask <- read.table("network_mask.txt", header = TRUE)

# read in df
df <- read.table("panss_g_5000_dat_ztstat_pscalar.txt", header = FALSE)
...
pdf("panss_g_cortical.pdf", width=4.5,height=4.5)
...
pdf("panss_g_subcortical.pdf", width=2.3,height=4.5)
...
# t = -7.6911, df = 1343.1, p-value = 2.806e-14
...
pdf("panss_g_assoc_sens.pdf", width=2,height=4.5)
